...
/* cookie.JS
 ========================================================*/
include('wp-content/themes/gordondaloshostel/js/jquery.cookie.js');

/* Easing library
 ========================================================*/
include('wp-content/themes/gordondaloshostel/js/jquery.easing.1.3.js');
...
(function ($) {
    ...
    if (o.hasClass('desktop')) {
        include('wp-content/themes/gordondaloshostel/js/tmstickup.js');
...
(function ($) {
    var o = $('html');
    if (o.hasClass('desktop')) {
        include('wp-content/themes/gordondaloshostel/js/jquery.ui.totop.js');
...
(function ($) {
	...
	include('../wp-content/themes/gordondaloshostel/js/superfish.js');
	jQuery(function () {
})
})(jQuery);
...
;
(function ($) {
    include('wp-content/themes/gordondaloshostel/js/jquery.rd-navbar.js');
})(jQuery);
...
(function ($) {
    ...
    if (o) {
        ...
        include('wp-content/themes/gordondaloshostel/js/jquery.rd-google-map.js');
...
(function ($) {
    ...
    if ((navigator.userAgent.toLowerCase().indexOf('msie') == -1 ) || (isIE() && isIE() > 9)) {
        if (o.hasClass('desktop')) {
            include('wp-content/themes/gordondaloshostel/js/wow.js');
...
var o = $('#camera');
    if (o.length > 0) {
        if (!(isIE() && (isIE() > 9))) {
            include('wp-content/themes/gordondaloshostel/js/jquery.mobile.customized.min.js');
        }

        include('wp-content/themes/gordondaloshostel/js/camera.js');
...
=============================================*/
;(function ($) {
    include('wp-content/themes/gordondaloshostel/js/jquery.form.min.js');
    include('wp-content/themes/gordondaloshostel/js/jquery.rd-mailform.min.js');
})(jQuery); 
...
$(document).ready(function () {
	$('head').append('<link rel="stylesheet" href="wp-content/themes/gordondaloshostel/css/tm_docs.css" type="text/css" media="screen"><link href="wp-content/themes/gordondaloshostel/css/tm_panel.css" rel="stylesheet">');
...
=============================================*/
;(function ($) {
    include('wp-content/themes/gordondaloshostel/js/jquery.rd-parallax.js');
})(jQuery); 
